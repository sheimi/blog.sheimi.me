...
class DataList<T, V, W> implements IDataList<T, V, W> {
  ...
  public IDataList<T, V, W> getAProxy() {return new DataListProxyA<T, V, W>(this)}
  public IDataList<T, V, W> getBProxy() {return new DataListProxyB<T, V, W>(this)}
  public IDataList<T, V, W> getCProxy() {return new DataListProxyC<T, V, W>(this)}
